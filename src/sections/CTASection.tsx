        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-black/20 p-8 sm:p-12 lg:p-16 backdrop-blur-xl text-center">
            ...
            <div className="space-y-8 sm:space-y-10">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight [text-wrap:balance]">
              ...
              <p className="mx-auto max-w-3xl text-lg sm:text-xl md:text-2xl font-medium text-white/90 leading-relaxed [text-wrap:balance]">
              ...
              <div className="flex flex-col items-center gap-4 sm:gap-6">
                <p className="text-base sm:text-lg text-white/90 [text-wrap:balance]">
            ...
            <div className="mt-10 sm:mt-12">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 w-full max-w-lg sm:max-w-none">
                ...
                <button className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 hover:border-white/30 text-white/90 hover:text-white rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-transparent">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 md:gap-12 mt-12 sm:mt-16 text-white/80">
